...
public class VehicleAgencyMain 
{
       ...
       if(selection != 8)
        {
            ...
            case 3:  
                ...
                break;
            case 4:
                System.out.println("Enter VIN for reservation you would like to see.");
                v = getVehicle(agency_vehicles); 
                displayReservation(); 
                break;
            case 5:
                System.out.println("Enter VIN for reservation you would like to cancel.");
                v = getVehicle(agency_vehicles); 
                cancelReservation(v);
            ...
            case 6:
                ...
                break;
            case 7:
                System.out.println("Enter VIN for vehicle you want to remove.");
