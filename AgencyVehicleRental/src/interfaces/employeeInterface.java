...
public class employeeInterface implements userInterface
{
	...
	{
		System.out.println("Please enter in VIN for vehicle.");
		input.nextLine();
	...
	{
		System.out.println("Please enter number of days used.");
	...
	{
		System.out.println("Please enter 1 for car, 2 for SUV, or 3 for truck.");
	...
	private RentalDetails getRentalDetails(Scanner input)
	{
		...
		System.out.println("Please enter the estimated number of miles driven");
