...
public class systemInterface 
{
	...
	public static String[] updateCarRates(VehicleRates r)
	{
		...
		updateCarRates[0] = "The car rates have been updated.";
	...
	public static String[] updateSUVRates(VehicleRates r)
	{
		...
		updateSUVrates[0] = "The SUV rates have been updated."; 
	...
	public static String[] updateTruckRates(VehicleRates r)
	{
		...
		updateTruckRates[0] = "The truck rates have been updated.";
	...
	public static String[] estimatedRentalCost(RentalDetails details)
	{
		...
		rentalCost[0] = "Your estimated rental cost is: $" + agency_rates.calcEstimatedCost(veh, rental, miles, insur, prime); 
		return rentalCost; 
	}
			...
			throws VINNotFoundException, UnreservedVehicleException 
	{
		...
		Vehicle v = agency_vehicles.getVehicle(VIN);
		v.cancelReservation();
		cancelRes[0] = "Your reservation has been cancelled.";
		return cancelRes;
	}
